...
plt.step(t1935[0],t1935[1]+8 + (1 - (np.mean(t1935[1]))), label='2M'+str(t1935[3])+' '+str(t1935[2]), color='black')
plt.step(t0027[0],t0027[1]+7 + (1 - (np.mean(t0027[1]))), label='2M'+str(t0027[3])+' '+str(t0027[2]), color='black')
plt.step(t0241[0],t0241[1]+6 + (1 - (np.mean(t0241[1]))), label='2M'+str(t0241[3])+' '+str(t0241[2]), color='black')
plt.step(t0117[0],t0117[1]+5 + (1 - (np.mean(t0117[1]))), label='2M'+str(t0117[3])+' '+str(t0117[2]), color='black')
plt.step(t0045[0],t0045[1]+4 + (1 - (np.mean(t0045[1]))), label='2M'+str(t0045[3])+' '+str(t0045[2]), color='black', lw=2)
plt.step(t1551[0],t1551[1]+3 + (1 - (np.mean(t1551[1]))), label='2M'+str(t1551[3])+' '+str(t1551[2]), color='black')
plt.step(t2154[0],t2154[1]+2 + (1 - (np.mean(t2154[1]))), label='2M'+str(t2154[3])+' '+str(t2154[2]), color='black')
plt.step(t1615[0],t1615[1]+1 + (1 - (np.mean(t1615[1]))), label='2M'+str(t1615[3])+' '+str(t1615[2]), color='black')
plt.step(t0047[0],t0047[1]+0 + (1 - (np.mean(t0047[1]))), label='2M'+str(t0047[3])+' '+str(t0047[2]), color='black')
...
plt.annotate(str(t0253[3][0:7])+' M7', (1.233,11.25), fontsize=20, color='black')
plt.annotate(str(t0534[3][0:7])+' M8', (1.233,10.25), fontsize=20, color='black')
plt.annotate(str(t1935[3][0:7])+' M9', (1.233,9.25), fontsize=20, color='black')
plt.annotate(str(t0027[3][0:7])+' M9.5', (1.233,8.25), fontsize=20, color='black')
plt.annotate(str(t0241[3][0:7])+' L0', (1.233,7.25), fontsize=20, color='black')
plt.annotate(str(t0117[3][0:7])+' L1', (1.233,6.25), fontsize=20, color='black')
plt.annotate(str(t0045[3][0:7])+' L2', (1.233,5.25), fontsize=20, color='black')
plt.annotate(str(t1551[3][0:7])+' L4', (1.233,4.25), fontsize=20, color='black')
plt.annotate(str(t2154[3][0:7])+' L4', (1.233,3.25), fontsize=20, color='black')
plt.annotate(str(t1615[3][0:7])+' L4', (1.233,2.25), fontsize=20, color='black')
plt.annotate(str(t0047[3][0:7])+' L7', (1.233,1.25), fontsize=20, color='black')
